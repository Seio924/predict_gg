...
const { SEND_MAIN_PING, SEND_WINDOW_MINIMIZE, SEND_WINDOW_MAXIMIZE, SEND_WINDOW_CLOSE, SEND_MATCH_INFO, SEND_PREDICT_GAME } = require("./constants");
const fs = require("fs").promises; // 비동기 파일 쓰기를 위해 fs.promises 사용
const request = require("request");
const { spawn } = require("child_process");

const apiKey = "RGAPI-b9b1e087-8919-47eb-b72c-0962e8fe9a6c";
