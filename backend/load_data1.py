...
class LoadData():
    ...
    def get_match_data(self, matchid):
        ...
        with open('backend/api_match_info1.json', 'w', encoding='utf-8') as json_file:
    ...
    def get_timeline_data(self, matchid):
        ...
        with open('backend/api_timeline_info1.json', 'w', encoding='utf-8') as json_file:
    ...
    def get_summoner_invertal_list(self, summoner_start, num_matches):
        ...
        for summoner_name in summonerId:
            ...
            for match_id in match_ids:
                ...
                with open('backend/api_match_info1.json', 'r', encoding="utf-8") as f:
                    match_info = json.load(f)

                with open('backend/api_timeline_info1.json', 'r', encoding="utf-8") as f:
                ...
                test = PreprocessData('./backend/api_match_info1.json', './backend/api_timeline_info1.json')
            ...
            if num == num_matches:
                ...
                with open("backend/api_win_lose_list1.txt", "w") as file:
                    # 리스트의 각 요소를 파일에 쓰기
