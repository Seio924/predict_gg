...
def rnn_sequential(model, model_name, h_dim, return_seq):
    ...
    if model_name == 'rnn':
        model.add(tf.keras.layers.SimpleRNN(h_dim, return_sequences=return_seq))
    elif model_name == 'lstm':
        model.add(tf.keras.layers.LSTM(h_dim, return_sequences=return_seq))
    elif model_name == 'gru':
        model.add(tf.keras.layers.GRU(h_dim, return_sequences=return_seq))
