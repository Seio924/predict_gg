...
class LoadData():
    ...
    def get_match_data(self, matchid):
        ...
        with open('api_data/api_match_info5.json', 'w', encoding='utf-8') as json_file:
    ...
    def get_timeline_data(self, matchid):
        ...
        with open('api_data/api_timeline_info5.json', 'w', encoding='utf-8') as json_file:
    ...
    def get_summoner_invertal_list(self, summoner_start, num_matches):
        ...
        for summoner_name in summonerId:
            ...
            for match_id in match_ids:
                ...
                with open('api_data/api_match_info5.json', 'r', encoding="utf-8") as f:
                    match_info = json.load(f)

                with open('api_data/api_timeline_info5.json', 'r', encoding="utf-8") as f:
                ...
                test = PreprocessData('./api_data/api_match_info5.json', './api_data/api_timeline_info5.json')
            ...
            if num == num_matches:
                with open("api_data/api_interval_list5-4.txt", "w") as file:
                    # 리스트의 각 요소를 파일에 쓰기
                    for item in data_list:
                        file.write(str(item) + "\n")

                with open("api_data/api_win_lose_list5-4.txt", "w") as file:
                    # 리스트의 각 요소를 파일에 쓰기
...
if __name__ == "__main__":
    load_data_instance = LoadData(api_key='RGAPI-23bf7815-770f-48b4-ab58-d8ea5bb8a498') #현욱2api
    # load_data_instance.get_summoner_invertal_list(summoner_start=500, num_matches=2500) 
    # load_data_instance.get_summoner_invertal_list(summoner_start=1250, num_matches=2500) 
    # load_data_instance.get_summoner_invertal_list(summoner_start=2000, num_matches=2500) 
    load_data_instance.get_summoner_invertal_list(summoner_start=2750, num_matches=2500) 