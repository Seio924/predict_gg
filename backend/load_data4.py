...
class LoadData():
    ...
    def get_match_data(self, matchid):
        ...
        with open('api_data/api_match_info4.json', 'w', encoding='utf-8') as json_file:
    ...
    def get_timeline_data(self, matchid):
        ...
        with open('api_data/api_timeline_info4.json', 'w', encoding='utf-8') as json_file:
    ...
    def get_summoner_invertal_list(self, summoner_start, num_matches):
        ...
        for summoner_name in summonerId:
            ...
            for match_id in match_ids:
                ...
                with open('api_data/api_match_info4.json', 'r', encoding="utf-8") as f:
                    match_info = json.load(f)

                with open('api_data/api_timeline_info4.json', 'r', encoding="utf-8") as f:
                ...
                test = PreprocessData('./api_data/api_match_info4.json', './api_data/api_timeline_info4.json')
            ...
            if num == num_matches:
                with open("api_data/api_interval_list4.txt", "w") as file:
                    # 리스트의 각 요소를 파일에 쓰기
                    for item in data_list:
                        file.write(str(item) + "\n")

                with open("api_data/api_win_lose_list4.txt", "w") as file:
                    # 리스트의 각 요소를 파일에 쓰기
...
if __name__ == "__main__":
    load_data_instance = LoadData(api_key='RGAPI-791ac22b-0e6b-48b2-817b-8ca83ea244b8') #현욱1 api
