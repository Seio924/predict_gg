...
class PreprocessData():
    ...
    def get_match_data(self):
        ...
        aram = 1
        win_lose = [1, 1] #어떤 팀이 이겼는지 [team1, team2]
        team = {}
        line = {}
                ...
                for i in initial_data:
                    for j in i['events']:
                        ...
                        if j['type'] == 'ITEM_DESTROYED':
                            ...
                            if item_type == "boots" or item_type == "potion":
                                if line[participant_id] == "TOP":
                                    if item_type == "potion":
                                        event_list[TEAM1_TOP_POTION + team_interval] -= 1
                                        event_list[TEAM1_TOP_GOLD + team_interval] -= item_cost[item_id]
                                    else:
                                        event_list[BOOTS_ITEM + team_interval] -= 10000
                                elif line[participant_id] == "JUNGLE":
                                    if item_type == "potion":
                                        event_list[TEAM1_JUNGLE_POTION + team_interval] -= 1
                                        event_list[TEAM1_JUNGLE_GOLD + team_interval] -= item_cost[item_id]
                                    else:
                                        event_list[BOOTS_ITEM + team_interval] -= 1000
                                elif line[participant_id] == "MIDDLE":
                                    if item_type == "potion":
                                        event_list[TEAM1_MIDDLE_POTION + team_interval] -= 1
                                        event_list[TEAM1_MIDDLE_GOLD + team_interval] -= item_cost[item_id]
                                    else:
                                        event_list[BOOTS_ITEM + team_interval] -= 100
                                elif line[participant_id] == "BOTTOM":
                                    if item_type == "potion":
                                        event_list[TEAM1_BOTTOM_POTION + team_interval] -= 1
                                        event_list[TEAM1_BOTTOM_GOLD + team_interval] -= item_cost[item_id]
                                    else:
                                        event_list[BOOTS_ITEM + team_interval] -= 10
                                elif line[participant_id] == "UTILITY":
                                    if item_type == "potion":
                                        event_list[TEAM1_UTILITY_POTION + team_interval] -= 1
                                        event_list[TEAM1_UTILITY_GOLD + team_interval] -= item_cost[item_id]
                                    else:
                                        event_list[BOOTS_ITEM + team_interval] -= 1
                            elif item_type == "start":
                                event_list[START_ITEM + team_interval] -= 1
                        ...
                        if j['type'] == 'ITEM_SOLD':
                            ...
                            item_type = item_tear[str(j['itemId'])]
                            ...
                            participant_id = j['participantId']
                            line_type = line[participant_id]

                            if line_type == "TOP":
                                event_list[TEAM1_TOP_GOLD + team_interval] = minus_gold
                            elif line_type == "JUNGLE":
                        ...
                        if j['type'] == 'ITEM_UNDO':
                            ...
                            if j['beforeId'] == 0:
                                ...
                                after_id = str(j['afterId'])
                                item_after = item_tear[after_id]
                                if item_after == "boots" or item_after == "potion":
                                    line_type = line[j['participantId']]
                                    if line_type == "TOP":
                                        if item_after == "potion":
                                            event_list[TEAM1_TOP_POTION + team_interval] += 1
                                        else:
                                            event_list[BOOTS_ITEM + team_interval] += 10000
                                    elif line_type == "JUNGLE":
                                        ...
                                        if item_after == "potion":
                                            ...
                                            event_list[BOOTS_ITEM + team_interval] += 1
                                elif item_after == "start":
                                    event_list[START_ITEM + team_interval] += 1
                                elif item_after == "tier1":
                                    event_list[TIER1_ITEM + team_interval] += 1
                                elif item_after == "tier2":
                                    event_list[TIER2_ITEM + team_interval] += 1
                                elif item_after == "tier3":
                                    event_list[TIER3_ITEM + team_interval] += 1
                                elif item_after == "special":
                                    event_list[SPECIAL_ITEM + team_interval] += 1
                                elif item_after == "ward":
                                    event_list[WARD_ITEM + team_interval] += 1
                            else:
                                # beforeId가 0이 아니라는 말은 샀던걸 되돌렸다는 말. 그러면 beforeId만큼 tear를 내려줘야한다. 대신 상위아이템인 경우는 하위아이템만큼 더해준다.
                                before_id = str(j['beforeId'])
                                item_before = item_tear[before_id]
                                if item_before == "boots" or item_before == "potion":
                                    line_type = line[j['participantId']]
                                    if line_type == "TOP":
                                        if item_before == "potion":
                                            event_list[TEAM1_TOP_POTION + team_interval] -= 1
                                        else:
                                            event_list[BOOTS_ITEM + team_interval] -= 10000
                                    elif line_type == "JUNGLE":
                                        ...
                                        if item_before == "potion":
                                            ...
                                            event_list[BOOTS_ITEM + team_interval] -= 1
                                elif item_before == "start":
                                    event_list[START_ITEM + team_interval] -= 1
                                elif item_before == "tier1":
                                    event_list[TIER1_ITEM + team_interval] -= 1
                                elif item_before == "tier2":
                                    event_list[TIER2_ITEM + team_interval] -= 1
                                elif item_before == "tier3":
                                    event_list[TIER3_ITEM + team_interval] -= 1
                                elif item_before == "special":
                                    event_list[SPECIAL_ITEM + team_interval] -= 1
                                elif item_before == "ward":
                                    event_list[WARD_ITEM + team_interval] -= 1

                                item_from_data = self.get_item_from_data(before_id)
                                for i in item_from_data:
                                    item_i = item_tear[str(i)]
                                    if item_i == "boots" or item_i == "potion":
                                        line_type = line[j['participantId']]
                                        if line_type == "TOP":
                                            if item_i == "potion":
                                                event_list[TEAM1_TOP_POTION + team_interval] += 1
        ...
        if event_list == 0:
            ...
            if len(event_list) != 0 and len(participant_frame_list) != 0:
                ...
                for i in range(0, max_timeline, interval):
                    interval_list = whole_list[whole_list[:, 0] <= i].tolist()
